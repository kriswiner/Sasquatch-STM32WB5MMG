...
In addition to environmental sensors, the daughter board has an ePeas AEM13921 energy harvester for powering the intended [105 mAH LiPo](https://www.adafruit.com/product/1570) battery using a Panasonic [AM-5412CAF](https://www.digikey.com/en/products/detail/panasonic-energy/AM-5412CAR-DGK-T/2165192) amorphous silicon solar cell. The daughter board also has the LC709204F fuel gauge, but we have found this unreliable (prone to I2C latchup) as well as being out of production; so the fuel gauge is not used in this application.
