...
class LIS2DW12
{
  ...
  uint8_t getChipID();
  void init(uint8_t fs, uint8_t odr, uint8_t mode, uint8_t lpMode, uint8_t bw, bool lowNoise, bool stMode);
  ...
  void activateWakeOnMotionInterrupt();
  void deactivateWakeOnMotionInterrupt();
  uint8_t getStatus();
  void powerDown();
