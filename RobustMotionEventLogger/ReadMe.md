...
_30 trusted samples beginning ~100 ms after threshold detection (first FIFO sample is discarded per ST's LISDW12 data sheet). Data from the single motion event captured on flash and transferred to a spreadsheet for plotting._
